...
export const navController = {
  ...
  insertPages: function (
    ...
    // eslint-disable @typescript-eslint/ban-ts-comment
    //@ts-ignore
    const htmlcomponents: NavComponent[] | NavComponentWithProps[] =
      insertComponents.map(
  ...
  popTo: function (
    ...
    const _nav = document.querySelector("ion-nav") as HTMLIonNavElement;
    return _nav !== undefined
      ? _nav.popTo(indexOrViewCtrl, opts, done)
      : undefined;
  },
  ...
  push: function <T extends NavComponent>(
    ...
    const htmlcomponent = createHTMLCompFromSvelte(component, componentProps);
    return _nav !== undefined
      ? _nav.push(htmlcomponent, componentProps, opts, done)
      : undefined;
  },
  ...
  removeIndex: function (
    ...
    const _nav = document.querySelector("ion-nav") as HTMLIonNavElement;
    return _nav !== undefined
      ? _nav.removeIndex(startIndex, removeCount, opts, done)
      : undefined;
  },
  ...
  setPages: function (
    ...
    return _nav !== undefined
      ? _nav.setPages(htmlcomponents, opts, done)
      : undefined;
  },
  ...
  setRoot: function <T extends NavComponent>(
    ...
    const htmlcomponent = createHTMLCompFromSvelte(component, componentProps);
    return _nav !== undefined
      ? _nav.setRoot(htmlcomponent, componentProps, opts, done)
      : undefined;
  },
};
